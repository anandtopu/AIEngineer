...
def main():
    ...
    tests = [
        ...
        Path("src/basics/logistic_regression_numpy.py"),
        ...
        Path("src/rag/retrieval_eval_metrics.py"),
        ...
        Path("src/advanced/sklearn_pipeline_cv.py"),
        Path("src/advanced/calibration_demo.py"),
        Path("src/deep_learning/attention_from_scratch.py"),
        Path("src/deep_learning/pytorch_training_loop_mnist.py"),
